...
export default function InviteRewardsBox({ usageCount, totalXpEarned }: Props) {
  return (
    <div className="grid grid-cols-2 gap-4">
      <motion.div initial={{ scale: 0.9 }} animate={{ scale: 1 }} className="dark-card rounded-xl p-5 border border-green-900/30 bg-[#0d0d0d] text-center">
      ...
      <motion.div initial={{ scale: 0.9 }} animate={{ scale: 1 }} transition={{ delay: 0.1 }} className="dark-card rounded-xl p-5 border border-purple-900/30 bg-[#0d0d0d] text-center">
