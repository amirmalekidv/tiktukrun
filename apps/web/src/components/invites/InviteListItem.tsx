...
export default function InviteListItem({ user, index = 0 }: Props) {
  return (
    <div className="flex items-center gap-3 py-3 border-b border-white/10 last:border-b-0">
      <div className="w-8 h-8 rounded-full bg-[#00f5ff]/10 border border-[#00f5ff]/30 flex items-center justify-center text-[#00f5ff] text-sm font-cinzel flex-shrink-0">{index + 1}</div>
