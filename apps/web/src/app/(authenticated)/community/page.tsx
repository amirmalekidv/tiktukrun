  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button onClick={() => setShowCreate(true)} className="px-4 py-2 bg-red-900/40 border border-red-700/50 text-red-400 rounded-xl font-vazir text-sm hover:bg-red-800/50 transition-all">
          <i className="fas fa-plus ml-2" />ساخت تیم
        </button>
      </div>
